  ...
  return (
    <div className="flex flex-col gap-y-10 px-4">
      ...
      <div className="flex flex-col md:flex-row gap-10 justify-center items-center min-h-[50vh]">
        <div className=" w-full md:w-1/2 rounded-xl shadow-2xl p-4 min-h-[400px]">
          <section className=" rounded-xl flex flex-col gap-y-4 bg-secondary-0 mt-5">
        ...
        <div  className="w-full md:w-1/2 h-full rounded-xl shadow-2xl p-4 min-h-[400px]">
          <Map  />
        </div>
      </div>
    </div>
