const CardInfo = ({ Icon, text ,id }) => {
  return (
    <div id={id} className="shadow-card dark:shadow dark:shadow-black/90 bg-secondary-0 flex flex-col gap-y-5 relative rounded-3xl w-96 md:w-3/4 lg:w-full h-32 items-center justify-center   p-2 mb-10">
